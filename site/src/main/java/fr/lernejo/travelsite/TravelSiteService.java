...
public class TravelSiteService {
    ...
    public List<TravelDTO> getTravelsByUsername(String userName) throws UnknownUserNameException {
        if (userName == null || !inscriptions.containsKey(userName)) throw new UnknownUserNameException(userName);
        List<TemperatureResponseDTO> temperatureResponses = fetchTemperaturesFromApi();
    ...
    public void registerUser(InscriptionDTO inscriptionObj) throws InvalidInscriptionException {
        if (inscriptionObj.isInvalidInscription(countries)) throw new InvalidInscriptionException();
